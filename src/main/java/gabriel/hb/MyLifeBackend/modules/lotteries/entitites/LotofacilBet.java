...
@Entity
@Table(name="tb_lt_aposta_lotofacil")
public class LotofacilBet implements Serializable{
	...
	public LotofacilBet(Long id, Long targetDrawId, int evenCount, int oddCount, int repeatedCount, double cost,
			int hits, boolean isChecked, Double prize, boolean autoGenerated, LocalDate betDate, List<LotofacilBetNumber> betNumbers,
