...
public class GenerateContestRequest {
    ...
    /* Construtores */
    public GenerateContestRequest() {
    	
    }
    
	public GenerateContestRequest(Long concursoAnteriorId, int qtdPares, int qtdImpares, int qtdRepetidos) {
		super();
